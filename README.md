...
> *Trace how income is generated, redistributed, saved, and ultimately invested across sectors of the New Zealand economy — linking financial flows to real capital accumulation.*
...
The analysis is delivered as a single Google Colab notebook (`NZ_National_Accounts_Analysis_v2.ipynb`) with 95 cells across 9 modules.
...
**41 of 44 questions are fully answered.** The three not answered (Q12, Q32, Q44) require data — household debt, total factor productivity, and three-measure GDP reconciliation — not included in the source files.
...
3. Open `NZ_National_Accounts_Analysis_v2.ipynb` in Google Colab
4. In **Cell 1**, update `DATA_PATH` to point to your files:
   ```python
   # Option A — Direct upload to Colab session
   DATA_PATH = '/content/'
...
```
├── NZ_National_Accounts_Analysis_v2.ipynb   # Main analysis notebook
├── README.md                                 # This file
└── data/
    ├── na-nov2025-institutional-sector-accounts.csv
    ├── na-nov2025-capital-stocks.csv
    ├── na-nov2025-gdp-breakdown.csv
    ├── na-nov2025-hce.csv
    ├── na-nov2025-taxes.csv
    ├── na-nov2025-agriculture.csv
    └── na-nov2025-per-capita.csv
```
...
- Household **debt and borrowing** data (Q12) is not in the institutional sector accounts and would require the financial accounts table from Stats NZ.
